...
export function AuthContent({ initialCodes }: AuthContentProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-auto pt-[72px] pb-[50px] px-4">
        <div className="max-w-md mx-auto">
          <div className="flex flex-col gap-4">
            {codes.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 px-4 border-2 border-dashed border-gray-300 rounded-lg animate-in fade-in duration-500">
